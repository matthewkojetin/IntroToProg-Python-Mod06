...
# mkoj,5.25.2020,Added code to functions in the Processor class
# mkoj,5.25.2020,Added code to functions in the IO class
# mkoj,5.25.2020,Added called each function at the appropriate place in the main body
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        dicRow = {"Task": task, "Priority": priority}  # adds inputs to task and priority key
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = input("Priority: ").strip()  # adds inputs to task and priority key
        return task, priority # return task, priority

    @staticmethod
    def input_task_to_remove():
        print("Remove an item from the list:\n")
        task = input(str("Enter task would you like to remove: ")).strip()
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new task
        ...
        strChoice = IO.input_task_to_remove()
        Processor.remove_data_from_list(strChoice, lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
        ...
        IO.input_press_to_continue("Goodbye.")
        break   # and Exit
    else:
        # Catch-all in case user enters a value that is not valid
        IO.input_press_to_continue("Invalid selection.")